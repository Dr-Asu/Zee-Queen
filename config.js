...
module.exports = {
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ZEE QUEEN' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://wa.me/+923077761554' : process.env.SOCIAL_MEDIA,
